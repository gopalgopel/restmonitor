...
<head>
    ...
    <title>Resilient Server Monitor - <?php echo Misc::getHostname(); ?></title>
...
<nav role="main">
    <div id="appname">
        <a href="index.php"><img src="notif.png" alt="Smiley face" height="30" width="30" style="margin-top: 4px;">Resilient</a>
        <a href="<?php echo $Config->get('esm:website'); ?>"><span class="subtitle">Resilient Server Monitor - v<?php echo $Config->get('esm:version'); ?></span></a>
    </div>
